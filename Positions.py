...
class Positions:
    ...
    def __init__(self, pos_guess: NDArray[Shape["4"], Int], toll) -> None:
        self.x0 = pos_guess
        self.toll = toll
        self.sat_amount = 0
        self.theta = []
    ...
    def add_satellite_polar(self, theta, phi):
        self.sat_amount += 1
        self.theta.append(theta)
        self.phi.append(phi)
        A, B, C, t = self.cartesian_calc(theta, phi)
        self.A.append(A)
        self.B.append(B)
        self.C.append(C)
        self.t.append(t)

    def add_satellite_cart(self, x, y, z, t):
        self.sat_amount += 1
        self.A.append(x)
        self.B.append(y)
        self.C.append(z)
    ...
    def random_sat_angles(self, pos_amount: int, sat_amount: int):
        '''
